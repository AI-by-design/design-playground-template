...
Once all 🔴 and 🟡 items are fixed, print this block exactly:
...
What just happened
- [N] 🔴 broken items fixed
- [N] 🟡 mismatched-intent items fixed
- [N] 🟠 missing states/flows filled in
- Regressions re-checked against the flows in PLAN.md

What's next
- Run `/evaluate` to quality-gate the fixes (tokens, a11y, brand alignment)
- If more build parts remain in PLAN.md: run `/build-component` (if Primitiv is installed) or say "let's build" to continue
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
